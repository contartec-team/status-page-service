...
class StatusService {
  ...
  */
  static async updateStatus(params = {}) {
    const webAPIResponse = await StatusService
      .getAPIResponse(params)
    
    console
      .warn(`[StatusService.updateStatus] ${new Date()} webAPIResponse`, {
        webAPIResponse
      })
    ...
    if (webAPIResponse) {
      console
        .warn(`[StatusService.updateStatus] ${new Date()} webAPIResponse ${webAPIResponse.status}`, {
